    ...
    <div id="nav">
      <div id="nav-container">
        <div class="logo-container">
          <img :src="$isDev ? require('./assets/img/Molnav Logo 1.png') : `${$remoteHost}img/Molnav Logo 1.png`" />
        </div>
      ...
      <div class="footer-contact-container">
        <div class="footer-contact" @click="goToLink($store.state.fb)">
          <div class="footer-img-container">
            <img
              :src="$isDev ? require('./assets/img/facebook.svg') : `${$remoteHost}img/facebook.svg`"
              alt="Facebook Icon"
            />
          </div>
        ...
        <div class="footer-contact" @click="openWapp($store.state.whatsapp)">
          <div class="footer-img-container">
            <img
              :src="$isDev ? require('./assets/img/whatsapp.svg') : `${$remoteHost}img/whatsapp.svg`"
              alt="Whatsapp Icon"
            />
          </div>
        ...
        <div class="footer-contact">
          <div class="footer-img-container">
            <img
              :src="$isDev ? require('./assets/img/mail-message.svg') : `${$remoteHost}img/mail-message.svg`"
              alt="Email Icon"
            />
          </div>
